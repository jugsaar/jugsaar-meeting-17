...
public class CoolController {
    ...
    public Map<String, Object> getAdminData(HttpServletRequest request, Principal principal) {

        Map<String, Object> map = getData(request,principal);
        map.put("data", "admin-data");
